...
- [Theming](./theming) — `createThemes` (one-line), `createTheme`, dark mode, high contrast
- [Providers](./providers) — `ThemeProvider`, `PortalProvider`, `ErrorBoundary`
- [Components](./components) — ~145 components organised by domain
- [Blocks](./blocks) — 74 ready-made screen blocks
- [Icons](./icons) — tree-shakeable, customizable icon set
